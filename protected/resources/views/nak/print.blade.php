        ...
        <div class="card-body">
            ...
            <table border="1" style="width:100%; border-style: ridge;  border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td>BARU</td>
                    <td></td>
                    <td>{{ $data_header->bunga }} % p.a.eff</td>
                    <td>IDR</td>
                    <td style="width:10%; text-align:right;">{{ number_format($data_header->plafond) }}</td>
                    <td style="width:15%; text-align:right;">0</td>
                    <td style="width:10%; text-align:right;">{{ number_format($data_header->plafond) }}</td>
                    <td style="width:10%; text-align:right;">{{ number_format($data_header->plafond) }}</td>
                    <td>{{ $data_header->tenor }} Bulan<br/> Sejak Fasilitas kredit <br/> efektif</td>
                </tr>
