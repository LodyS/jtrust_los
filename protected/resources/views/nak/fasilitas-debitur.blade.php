                ...
                <form action="{{ url('simpan-fasilitas-debitur') }}" method="POST">@csrf
                    ...
                    <table class="table table-bordered  table-sm" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td style="font-size:11px">BARU</td>
                            <td style="font-size:11px"></td>
                            <td style="font-size:11px">{{ $data->bunga }} % p.a.eff</td>
                            <td style="font-size:11px">IDR</td>
                            <td style="width:10%; text-align:right; font-size:11px">{{ number_format($data->plafond) }}</td>
                            <td style="width:15%; text-align:right; font-size:11px">0</td>
                            <td style="width:10%; text-align:right; font-size:11px">{{ number_format($data->plafond) }}</td>
                            <td style="width:10%; text-align:right; font-size:11px">{{ number_format($data->plafond) }}</td>
                            <td style="font-size:11px">{{ $data->tenor }} Bulan<br/> Sejak Fasilitas kredit <br/> efektif</td>
                        </tr>

                        <tr>
                            <td colspan="6"><b>Total</td>
                            <td style="font-size:11px; text-align:right">{{ number_format($data->plafond) }}</td>
                            <td></td>
                            <td style="text-align:right; font-size:11px">{{ number_format($data->plafond) }}</td>
                            <td style="text-align:right; font-size:11px">{{ number_format($data->plafond) }}</td>
                            <td></td>
                        </tr>
                    </table>
