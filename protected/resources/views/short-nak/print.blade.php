...
<div class="ariel">
    <title>NAK - {{ strtoupper(\App\Models\InformasiPokokBprPelapor::namaBpr($data->sandi_bpr)->nama_bpr) ?? '' }}</title>

    <div style="height:30px"></div>

    <table class="table table-bordered table-sm">
        <tr>
            <td colspan="2" style="text-align:center;"><b>NOTA ANALISA KREDIT (NAK)<br/>SHORT FORM</b></td>
            <td rowspan="4"><br/><br/><img src="{{ url('logo/jtrust.jpg') }}" width="250px" class="center"></td>
        </tr>
            
        <tr>
            <td><b>No NAK Short Form</b></td>
    ...
    <p align="justify" style="font-size:14px">Business Unit bertanggung jawab terhadap kebenaran, validasi, dan kekinian data yang digunakan untuk menyusun NAK long form.</p>

    <p align="justify" style="font-size:14px">Masa berlaku NAK long form adalah 90 (Sembilan puluh) hari yang dihitung sejak tanggal NAK disetujui oleh Komite Kredit
    (setelah approval kredit) sampai dengan tanggal penandatanganan Perjanjian Kredit.</p>

    <p align="justify" style="font-size:14px">Apabila Debitur mengajukan ketentuan dan kondisi yang berbeda,
    ...
    <p align="justify" style="font-size:14px">Apabila Perjanjian Kredit ditandatangani lebih dari 30 (tiga puluh)
    ...
    <p align="justify" style="font-size:14px">Apabila Perjanjian Kredit belum ditandatangani setelah 90 (sembilan puluh) hari,
