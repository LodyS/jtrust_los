...
class DataKepemilikanBprController extends Controller
{
    public function index ()
    {
        return view ('form/form-001/index');
    }
        ...
        try {
            ...
            if ($id_header == null):
                ...
                while (!feof($open)):
                    ...
                    $txt = new DataKepemilikanBpr();
                    $txt->storeDataKepemilikanBpr($explodeLine);

                    DataKepemilikanBpr::where('nama', 'Data Kosong Laravel')->delete();
                endwhile;

            else:

                Header::find($id_header)->delete();
                DataKepemilikanBpr::where('header_id', $id_header)->delete();
            ...
            fclose($open);
            DB::commit();
            return redirect('/data-kepemilikan-bpr')->with('success', 'Data Saved Successfully');
