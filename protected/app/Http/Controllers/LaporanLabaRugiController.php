...
class LaporanLabaRugiController extends Controller
{
    ...
    {
        return view ('form/form-02/index');
    }
        ...
        try {
            ...
            if ($id_header == null):
                ...
                while (!feof($open)):
                    ...
                    $txt = new LaporanLabaRugi();
                    $txt->storeLaporanLabaRugi($explodeLine);
                endwhile;
                LaporanLabaRugi::where('sandi_kantor', 'kosong')->delete();

            else:

                Header::find($id_header)->delete();
                LaporanLabaRugi::where('header_id', $id_header)->delete();
            ...
            fclose($open);
            DB::commit();
            return redirect('/form-laporan-laba-rugi')->with('success', 'Data Saved Successfully');
