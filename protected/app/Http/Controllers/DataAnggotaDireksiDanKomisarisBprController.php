...
class DataAnggotaDireksiDanKomisarisBprController extends Controller
{
    public function index ()
    {
        return view ('form/form-002/index');
    }
        ...
        try {
            ...
            if ($id_header == null):
                ...
                while (!feof($open)):
                    ...
                    $txt = new DataAnggotaDireksiKomisarisBpr();
                    $txt->storeDataAnggotaDireksiKomisarisBpr($explodeLine);
                endwhile;

                DataAnggotaDireksiKomisarisBpr::where('nama', 'Data Kosong')->delete();

            else:

                Header::find($id_header)->delete();
                DataAnggotaDireksiKomisarisBpr::where('header_id', $id_header)->delete();
            ...
            fclose($open);
            DB::commit();
            return redirect('/data-anggota-direksi-dan-komisaris-bpr')->with('success', 'Data Saved Successfully');
