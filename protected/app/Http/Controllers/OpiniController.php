...
class OpiniController extends Controller
{
    ...
    public function complianceOpini ($id)
    {
        $data = LoanApplicant::where('uuid',$id)->firstOrFail();
    ...
    public function opiniLegal(Request $request)
    {
        DB::beginTransaction();
    ...
    public function opiniCompliance(Request $request)
    {
        DB::beginTransaction();
    ...
    public function opiniCad(Request $request)
    {
        DB::beginTransaction();
