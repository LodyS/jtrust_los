...
class DaftarRincianKantorBprController extends Controller
{
    public function index ()
    {
        return view ('form/form-004/index');
    }
        ...
        try {
            ...
            if ($id_header == null):
                ...
                while (!feof($open)):
                    ...
                    $txt = new DaftarRincianKantorBpr();
                    $txt->storeDaftarRincianKantorBpr($explodeLine);
                endwhile;

                DaftarRincianKantorBpr::where('sandi_kantor', 'Data Kosong')->delete();

            else:

                Header::find($id_header)->delete();
                DaftarRincianKantorBpr::where('header_id', $id_header)->delete();
            ...
            fclose($open);
            DB::commit();
            return redirect('/daftar-rincian-kantor-bpr')->with('success', 'Data Saved Successfully');
